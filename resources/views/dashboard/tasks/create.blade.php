            ...
            <form action="{{ route('dashboard.boards.tasks.store', $board) }}" method="POST" class="space-y-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <div class="space-y-4">
                            <div class="relative">
                                <label class="block text-sm font-medium text-orange-700 dark:text-orange-300 mb-1"
                                    for="hard-deadline">
                                    Hard Deadline
                                </label>
                                <div
                                    ...
                                    <input class="form-input !bg-transparent !border-0 !p-0 !ring-0" id="hard-deadline"
                                        name="hard_deadline" type="datetime-local"
                            ...
                            <div class="relative">
                                ...
                                <div
                                    ...
                                    <input class="form-input !bg-transparent !border-0 !p-0 !ring-0" id="soft-due-date"
                                        name="soft_due_date" type="datetime-local"
                                        value="{{ old('soft_due_date') ?? ($task->soft_due_date?->format('d-M-Y') ?? '') }}">
                                    </input>
                                </div>
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <div x-data="{ subtasks: [] }" class="space-y-3">
                        ...
                        <template x-for="(subtask, index) in subtasks" :key="index">
                            <div
                                class="flex items-center space-x-4 p-3 rounded-lg bg-white dark:bg-slate-900 shadow-sm border border-slate-200 dark:border-slate-800">
                                <!-- Checkbox -->
                                ...
                                <!-- Subtask title -->
                                <input type="text" x-model="subtask.title" :name="`checklist[${index}][title]`"
