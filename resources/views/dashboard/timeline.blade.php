<x-app-layout>
    ...
    <div x-data="calendarBoard({ boards: @js($boards) })" x-init="init()"
        class="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 overflow-hidden shadow-sm p-4 sm:p-6">
            ...
            <div class="flex items-center gap-4">
                <div class="flex items-center gap-2 rounded-lg bg-slate-100 dark:bg-slate-800 p-1 text-sm">
                    ...
                    <button @click="setView('month')"
                        :class="{ 'bg-white dark:bg-slate-700 text-primary dark:text-white shadow': currentView === 'month', 'text-slate-600 dark:text-slate-300 hover:bg-white dark:hover:bg-slate-700': currentView !== 'month' }"
                ...
                <button
                    class="flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">
        ...
        <div class="overflow-x-auto">
            <div class="grid" :style="`grid-template-columns: 150px minmax(0, 1fr);`">
                <div class="sticky left-0 z-20 bg-white dark:bg-slate-900">
                    <div class="h-12 border-b border-r border-slate-200 dark:border-slate-800"></div>
                    <template x-for="project in projects" :key="project.id">
                        <div class="flex items-center p-4 border-b border-r border-slate-200 dark:border-slate-800"
                ...
                <div>
                    <div class="sticky top-0 z-10 bg-white dark:bg-slate-900 grid"
                        ...
                        <template x-for="unit in timeUnits" :key="unit.label">
                            <div class="text-center py-2 border-b border-slate-200 dark:border-slate-800 h-12">
