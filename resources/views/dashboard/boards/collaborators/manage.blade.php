                        ...
                        <div class="space-y-3">
                            @foreach ($board->collaborators as $collaborator)
                                @php
                                    ...
                                    $roleClasses = [
                                        'owner' =>
                                            'bg-pastel-pink text-pink-600 dark:bg-pink-900/50 dark:text-pink-300',
                                        'editor' =>
                                        ...
                                        'member' =>
                                            'bg-pastel-blue text-blue-600 dark:bg-blue-900/50 dark:text-blue-300',
                                    ];
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            @else
                                                <x-icon-button icon="delete" type="submit" color="slate"
                                                    :disabled="true" />
                                            @endif
                                        </div>
                                    </div>
