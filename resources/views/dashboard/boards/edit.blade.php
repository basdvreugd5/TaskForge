        ...
        <main class="flex-1 p-6 lg:p-10">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-white dark:bg-card-dark rounded-xl shadow-lg p-8 md:p-12 space-y-12">
                    <form class="space-y-10" method="POST" action="{{ route('dashboard.boards.update', $board) }}"
                        ...
                        <div>
                            ...
                            <x-text-input id="board-name" name="name" type="text"
                                class="form-input text-3xl font-bold" value="{{ old('title', $board->name) }}" />
                        </div>
                        <div>
                            ...
                            <x-text-input id="board-description" name="description" type="textarea" rows="5"
                                class="form-textarea leading-relaxed ">{{ old('description', $board->description) }}
                            </x-text-input>
                        </div>
                        <div>
