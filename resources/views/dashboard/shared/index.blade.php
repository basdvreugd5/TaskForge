           ...
           <!-- Tabs + New Task Button -->
            <div class="border-b border-slate-200 dark:border-slate-800 mb-6">
                <div class="flex justify-between items-center">
                    ...
                    <a href="{{ route('dashboard.index') }}" class="flex items-center justify-center border-b-2 border-transparent text-slate-500 dark:text-slate-400 hover:text-primary dark:hover:text-primary hover:border-primary/50 transition-colors pb-3">
            ...
            <div class="relative mb-8">
                ...
                <input class="form-input w-full rounded-lg border-slate-200 dark:border-slate-800 bg-white dark:bg-border-dark/30 focus:ring-primary focus:border-primary pl-12 py-3 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500" placeholder="Search shared boards..." type="text">
            </div>
                ...
                <li>
                    <a href="{{ route('dashboard.boards.show', $board) }}">
                        <div class="
                            ...
                            flex flex-col gap-4 shadow-sm hover:shadow-lg 
                            transition-shadow duration-300 min-h-[280px]
                            @if($role === 'owner') border-pastel-pink dark:border-pastel-pink-dark
                            @elseif($role === 'editor') border-pastel-blue dark:border-pastel-blue-dark
                            @else border-pastel-green dark:border-pastel-green-dark
                            @endif
                        ">
                            <div class="flex items-start justify-between">
                                ...
                                <span class="material-symbols-outlined mt-1 @if ($role === 'owner') text-neon-pink @elseif($role === 'editor') text-neon-blue @else text-neon-green @endif ">
